...
RULES = [
    ...
    (r'\.(?i)ace$', 'archives/'),
    (r'\.(?i)zip$', 'archives/'),
    (r'\.(?i)cab$', 'archives/windowscab/'),
    (r'\.(?i)tar$', 'archives/'),
    (r'\.(?i)rar$', 'archives/'),
    (r'\.(?i)7z$', 'archives/'),
    (r'\.(?i)bz2$', 'archives/'),
    (r'\.(?i)jar$', 'archives/jars/'),
    ...
    (r'\.(?i)reg$', 'windowssystem/registry/'),
    (r'\.(?i)lnk$', 'windowssystem/shortcut/'),
    (r'\.(?i)ini$', 'windowssystem/configuration/ini/'),
    (r'\.(?i)inf$', 'windowssystem/configuration/inf/'),
    (r'\.(?i)c$', 'source/c/'),
    (r'\.(?i)cpp$', 'source/cpp/'),
    (r'\.(?i)py$', 'source/python/'),
    (r'\.(?i)java$', 'source/java/'),
    (r'\.(?i)c#$', 'source/c#/'),
    (r'\.(?i)dat$', 'data_files/'),
    (r'\.(?i)csv$', 'data_files/'),
    (r'\.(?i)iso$', 'disc_images/iso/'),
    (r'\.(?i)xpi$', 'firefox/extensions/'),
    (r'\.(?i)jad$', 'javame/jads/'),
    (r'\.(?i)fnt$', 'fonts/'),
    (r'\.(?i)fon$', 'fonts/'),
    (r'\.(?i)otf$', 'fonts/'),
    ...
    (r'\.(?i)adr$', 'opera/addressbook_backups/'),
    (r'\.(?i)p2p$', 'peerguardian/lists/'),
    (r'\.(?i)vkp$', 'sony_ericsson/patches/'),
    (r'\.(?i)hid$', 'sony_ericsson/hid/'),
    (r'\.(?i)aswcs$', 'avast/themes/'),
    (r'\.(?i)vcf$', 'contacts/'),
